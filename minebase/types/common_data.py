...
class LegacyData(MinecraftDataModel):
    """Legacy Minecraft data mappings.
...
class FeatureValueData(MinecraftDataModel):
    """Represents a sub-feature of a Minecraft feature and the versions in which it is supported.
...
class FeatureData(MinecraftDataModel):
    """Represents a Minecraft feature definition.
    ...
    name: str
    # TODO: Description should be required after
    # https://github.com/PrismarineJS/minecraft-data/pull/1047
...
class CommonData(MinecraftDataModel):
    """Data common across all Minecraft versions, or metadata information.
    ...
    protocol_versions: list[ProtocolData]
